...
<div align="center">
   <center>
       <video id="video" width="300px" height="250px" autoplay></video>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#close").click(function() {
            ...
            <%--window.location.href="<%=request.getContextPath()%>/toAuth";--%>
        });
        //拍照
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                if(parseInt(data.result.user_list[0].score) > 90) {
                    ...
                    alert("验证成功!");
                    //验证成功跳转页面
                    location.href="<%=request.getContextPath()%>/book/listbook";
                }else{
                    alert("匹配失败");
                }
            },
